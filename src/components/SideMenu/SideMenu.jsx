...
export default function SideMenu() {
  ...
  return (
    <div
      className="d-flex flex-column border-end pt-3 pb-5 px-3 justify-content-between"
      id={styles.SideMenu}
    >
      <div className="d-flex flex-column gap-2">
        <div className="col-12 d-flex justify-content-center align-items-center gap-4 py-3">
        ...
        {links.map((el, index) => {
          return (
            <Link
              ...
              to={el.path}
              className={
                "col-12 ps-3 pe-3 d-flex gap-2 align-items-center nav-link " +
                styles.link +
                "  " +
